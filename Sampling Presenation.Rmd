...
![](https://jaidenneff.github.io/sta490/loan/datainfo1.png)          

---
<h2 align="center"> Data Description </h2>

![](https://jaidenneff.github.io/sta490/loan/datainfo2.png) 
---
...
![](https://jaidenneff.github.io/sta490/loan/SamplingPlans.png)
...
```{r}
loan01 = read.csv("https://jaidenneff.github.io/sta490/loan/subloan0.1.csv", header = TRUE)[, -1]
loan02 = read.csv("https://jaidenneff.github.io/sta490/loan/subloan0.2.csv", header = TRUE)[, -1]
loan03 = read.csv("https://jaidenneff.github.io/sta490/loan/subloan0.3.csv", header = TRUE)[, -1]
loan04 = read.csv("https://jaidenneff.github.io/sta490/loan/subloan0.4.csv", header = TRUE)[, -1]
loan05 = read.csv("https://jaidenneff.github.io/sta490/loan/subloan0.5.csv", header = TRUE)[, -1]
loan06 = read.csv("https://jaidenneff.github.io/sta490/loan/subloan0.6.2.csv", header = TRUE)[, -1]

loan3 = rbind(loan01, loan02, loan03, loan04, loan05, loan06)
```
...
#write.csv(loan3[1:100000,], "/Users/jaidenneff/Desktop/STA490/subloan0.1.csv")
#write.csv(loan3[100001:200000,], "/Users/jaidenneff/Desktop/STA490/subloan0.2.csv")
#write.csv(loan3[200001:300000,], "/Users/jaidenneff/Desktop/STA490/subloan0.3.csv")
#write.csv(loan3[300001:400000,], "/Users/jaidenneff/Desktop/STA490/subloan0.4.csv")
#write.csv(loan3[400001:500000,], "/Users/jaidenneff/Desktop/STA490/subloan0.5.csv")
#write.csv(loan3[500001:598499,], "/Users/jaidenneff/Desktop/STA490/subloan0.6.2.csv")
```
...
cluster_design <- svydesign(ids = ~Zip, data = loan3)

# Specify your sampling strategy (e.g., simple random sampling)
cluster_sample <- svydesign(ids = ~Zip, data = loan3)
